...
#Test-Script
case "$CodeType" in
	urrb	)FileDir="uart/rb7/formal/";;
	urrc	)FileDir="uart/rc7/formal/";;
	ur1b	)FileDir="uart/j1b/formal/";;
	ur1c	)FileDir="uart/j1c/formal/";;
	ur2b	)FileDir="uart/jgb/formal/";;
	srjth	)FileDir="uart/jpt/formal/";;
	ur2c	)FileDir="uart/jgc/formal/";; 
esac
