...
public class MyDispatcherServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        // 4.将 requestMapping 注释的 method 方法，放入到 Arraylist中
        initHandlerMapping();
    }

    private void doScanner(String packageName) {
        // 1.获取当前 class 的文件路径下的 com.panda.web 下的文件路径，
        URL resource =
                this.getClass().getClassLoader().getResource("/" + packageName.replaceAll("\\.", "/")); // /com/panda/web
        ...
        for (File classFile : classDir.listFiles()) {
            if (classFile.isDirectory()) {
                ...
                // 3.文件，直接获取文件名称，存放到 List 中，形式为 com.panda.web.controller.UserController
    ...
    private class Handler {
        ...
        protected Pattern pattern;   // url 正则表达式
