package com.objectmentor.utilities.args.v22;

import java.util.*;

/**
 * 代码清单 14-12 Args.java 首次重构后 p225-p228
 *    现在，Args 抛出的唯一一个异常是 ArgsException。把 ArgsException 移到它自己
 * 的模块中，这意味着我们能把大量杂七杂八的错误支持代码从 Args 模块移到这个模块。
 *    现在我们完全把异常和错误代码从 Args 模块中隔离出来了。
 */
public class Args {
