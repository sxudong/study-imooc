...
int main()
{
    ...
    *p = 200;
    ...
    // sizeof()指针类型在内存中的大小
    printf("%d\n", sizeof(p));     //4
    // 在 32 位操作系统中所有"指针大小"都是 4个字节大小
    // 在内在中内在分配按无符号 int 来为每一个内在分配编号，2^32-1=4294967295 对应 4GB 内容
    // 为什么 32 位系统只能用 4G 内存：https://blog.csdn.net/u011604775/article/details/81606194
    printf("int* = %d\n", sizeof(int*));       //4
    printf("char* = %d\n", sizeof(char*));     //4
    printf("short* = %d\n", sizeof(short*));   //4
    printf("long* = %d\n", sizeof(long*));     //4
