...
/**
 * 创建线程池  
 * @param thrnum      要创建的线程数
 * @param maxtasknum  最大任务数
 */
void create_threadpool(int thrnum,int maxtasknum)
{
    ...
    thrPool->shutdown = 0; //是否摧毁线程池，1代表摧毁，0代表不摧毁
...
{
    //printf("begin call %s-----\n",__FUNCTION__);
    pthread_mutex_lock(&pool->pool_lock); //线程池的互斥锁
	...
	//模拟循环，如数组下标0 1 2 3 4 5，5++=6，6取模6=0，又到数组下标启始处。
