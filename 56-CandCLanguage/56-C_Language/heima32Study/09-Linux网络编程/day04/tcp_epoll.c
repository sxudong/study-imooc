...
/**
 * IO复用--epoll
 * https://blog.csdn.net/weixin_45309916/article/details/107405616
 */
...
/*
# 客户端
aaron@aaron-virtual-machine:~$ nc -v 127.0.0.1 8080
Connection to 127.0.0.1 8080 port [tcp/http-alt] succeeded!
hello
HTTP/1.1 200 OK     //服务端读取数据后，更新事件为“写事件”，因为客户端连接成功同时具备“可读可写状态”，所以在下一轮循环时触发“可写事件”

<h1> hi girl </h1>

# 服务端
aaron@aaron-virtual-machine:~/CLionProjects/epoll/cmake-build-debug$ gcc -o tcp_epoll tcp_epoll.c
aaron@aaron-virtual-machine:~/CLionProjects/epoll/cmake-build-debug$ ./tcp_epoll 127.0.0.1 8080
listen and bind succeed
time out...
time out...
accept a client..[ip]: 127.0.0.1,[port]: 36964
client# hello
time out...
^C 
 */
