package com.SpringSourceAnalysis.ch08.jdbc;

import com.SpringSourceAnalysis.ch08.jdbc.pojo.User;
import com.SpringSourceAnalysis.ch08.jdbc.service.UserService;
...
public class SpringJDBCTest {
    public static void main(String[] args) {
        ...
        // 测试 queryForObject 查询。最大的不同是对于 RowMapper 的使用。SingleColumnRowMapper 类中的 mapRow。
        Long total = userService.queryCount();
